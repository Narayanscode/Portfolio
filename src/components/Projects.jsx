...
const projectsData = [
  {
    ...
    description:
      "A sleek and responsive portfolio website built with React JS, showcasing my projects, skills, and experiences. It is optimized for all devices, offering a smooth and engaging user experience.",
  ...
  switch (status) {
    case "Completed":
      return (
        <FontAwesomeIcon
          icon={faCheckCircle}
          className="icon-status-completed-icon"
          title="Completed"
        />
      );
    case "In Progress":
      return (
        <FontAwesomeIcon
          icon={faSpinner}
          className="status-progress-icon"
          spin
          title="In Progress"
        />
      );
...
const Projects = ({ isNightMode }) => {
  return (
    <div
      id="projects"
      className={`projects-container ${isNightMode ? "night-mode" : "day-mode"}`}
    >
      <h1>My Projects</h1>
            ...
            <div className="project-icons">
              ...
              {project.deploymentLink && (
                ...
                >
                  <FontAwesomeIcon
                    icon={faGlobe}
                    className="icon-deployment-icon"
                    title="Deployed Site"
                  />
                </a>
              )}
