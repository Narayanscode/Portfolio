      ...
      <div className="header-right">
        ...
        <nav className="desktop-nav">
          <ul>
            ...
            <li className="effect"><Link to="certifications" smooth={true} duration={500}>Certifications</Link></li>
          ...
          <div className="mobile-menu-overlay" onClick={() => setIsMenuOpen(false)}>
            <nav className="mobile-nav" onClick={(e) => e.stopPropagation()}>
              ...
              <ul>
                ...
                <li><Link to="certifications" smooth={true} duration={500} onClick={() => setIsMenuOpen(false)}>Certifications</Link></li>
